...
# `library_management/dock/library_management/library_management.json` for git to carry. An app that ships none has no
...
# setup_wizard_url = "/library_management/setup"
...
# before_disable = "library_management.uninstall.before_disable"
# after_disable = "library_management.uninstall.after_disable"
# before_enable = "library_management.install.before_enable"
# after_enable = "library_management.install.after_enable"
...
# awesomebar_search = ["library_management.search.awesomebar_results"]
...
# after_file_upload = ["library_management.utils.after_file_upload"]
